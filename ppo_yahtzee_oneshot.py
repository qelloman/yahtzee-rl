...
def parse_args():
    ...
    parser.add_argument("--gym-id", type=str, default="YahtzeeOneShot-v0",
...
if __name__ == "__main__":
    ...
    for update in range(1, num_updates + 1):
        ...
        if update % args.eval_freq == 0:
            eval_reward = eval(agent, eval_env, args.eval_num, device, log_dir=f"runs/{run_name}")
